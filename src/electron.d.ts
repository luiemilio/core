...
This method can only be called before app is ready.
    ...
    focus(): void;
    /**
     * Returns a new globally unique identifier as a string.
     */
    generateGUID(): string;
    /**
     * An Array of `NativeWindowInfo` objects for all top-level windows of the current
     * user's desktop.
     */
...
**Deprecated**
    ...
    /**
     * The system's unique identifier used by the RVM.
     */
    getCombinedId(): string;
    /**
     * The command line arguments passed to the runtime.
     */
    getCommandLineArguments(): string;
    /**
     * The command line arguments passed to the runtime as an array of strings.
     */
...
A unique (UUID) identifier for the machine.
     */
    getHostToken(): string;
    /**
...
**Deprecated**
    ...
    /**
     * Outputs `message` to the debug.log using the specified `level`. Accepted values
     * for `level` are `info`, `warning`, and `error`.

The result message.
     */
    log(level: string, message: string): string;
    makeSingleInstance(oldStyleFn: (...args: any[]) => void): boolean;
     ...
     *
     *
     * * `rootKey` String - The registry root key.
     * * `subkey` String - The registry key.
     * * `value` String - The registry value name.
     * * `data` String | String[] | Number | Object - The registry value's data.
     * `REG_DWORD` and `REG_QWORD` are returned as numbers. `REG_SZ` and
     * `REG_EXPAND_SZ` are returned as strings. `REG_MULTI_SZ` is returned as an array
     * of strings. Everything else is returned as an object that contains an array of
     * bytes:
...
* `browser-forward`
    ...
    addListener(event: 'deferred-set-bounds', listener: Function): this;
    removeListener(event: 'deferred-set-bounds', listener: Function): this;
    /**
    ...
    addListener(event: 'disabled-frame-bounds-changed', listener: Function): this;
    removeListener(event: 'disabled-frame-bounds-changed', listener: Function): this;
    /**
    ...
    addListener(event: 'disabled-frame-bounds-changing', listener: Function): this;
    removeListener(event: 'disabled-frame-bounds-changing', listener: Function): this;
    /**
    ...
    addListener(event: 'message/wm-copydata', listener: Function): this;
    removeListener(event: 'message/wm-copydata', listener: Function): this;
    /**
...
This cannot be called when `titleBarStyle` is set to `customButtonsOnHover`.
  ...
  class ChromeIpcClient extends NodeJS.EventEmitter {
...
* `diagnosticMode` Boolean
     */
    startOFCrashReporter(options: StartOFCrashReporterOptions): StartOFCrashReporter;
  }
...
**Deprecated: use the `savePath` property instead.**
  ...
  class ExternalProcess extends NodeJS.EventEmitter {
...
Returns the process id and handle in an object.
    ...
    /**
     * * `object` the object returned by launch() or attach()
...
Terminates the process.
  ...
  interface FileLock extends NodeJS.EventEmitter {

    // Docs: http://electronjs.org/docs\api\file-lock

    /**
     * the code of an error that was encountered, or 0 if no errors were encountered.
     */
...
* "Media Stop"
  ...
  class IdleState extends NodeJS.EventEmitter {
    ...
    constructor();
    /**
     * the elapsed time since the last keyboard/mouse event in milliseconds.
     */
    elapsedTime(): number;
    /**
     * true if the last keyboard/mouse event was over 1 minute ago, or the computer is
...
For example:
  ...
  class MessageWindow extends NodeJS.EventEmitter {
    ...
    destroy(): void;
    /**
     * Whether the message window is destroyed.
     */
    isDestroyed(): boolean;
    /**
  ...
  interface NamedMutex extends NodeJS.EventEmitter {
    ...
    /**
     * the code of an error that was encountered, or 0 if no errors were encountered,
     * or -1 if there was never a mutex with the given name.
     *
     * Note that because a process can lock a mutex more than once, this may not
     * actually allow other processes to lock the mutex that was released.
     * Additionally, releasing a mutex for the final time may not necessarily delete
     * the mutex outright. Thus, in order to entirely release a mutex, `releaseLock`
     * should be called until `errorCode` is non-zero.
     */
    releaseLock(name: string): number;
    /**
     * the code of an error that was encountered, or 0 if no errors were encountered.
     *
     * Note that if a process has already locked a given mutex, it can lock the same
     * mutex again. If a process locks a mutex X times, it must call `releaseLock()` X
     * times in order to fully release the mutex so other processes can lock it.
     */
    tryLock(name: string): number;
  }
...
**Deprecated**
  ...
  interface NativeWindowInfo {
    ...
    // Docs: http://electronjs.org/docs\api\structures\native-window-info
...
Calculate system idle time in seconds.
  ...
  class ProcessInfo extends NodeJS.EventEmitter {
    ...
    /**
     * Return the number of average idle cpu wakeups per second since the last call.
     */
    static getIdleWakeupsPerSecond(): void;
    /**
     * Returns accounting information for all I/O operations performed by the process.
     */
    static getIOCounters(): void;
    /**
     * Return the private and shared usage, in bytes. Private bytes is the amount of
     * memory currently allocated to a processt that cannot be shared. Returns false on
     * platform specific error conditions. Note private_bytes will be zero on
     * unsupported OSes: prior to XP SP2.
     */
    static getMemoryBytes(): void;
    /**
     * Return the current non-paged pool usage, in bytes.
     */
    static getNonPagedPoolUsage(): void;
    /**
     * Return the current paged pool usage, in bytes.
     */
    static getPagedPoolUsage(): void;
    /**
     * Return the number of page faults.
     */
    static getPageFaultCount(): void;
    /**
     * Return the current space allocated for the page file, in bytes (the pages may or
     * may not be in memory). On Linux, this returns the total virtual memory size.
     */
    static getPagefileUsage(): void;
    /**
     * Return the peak non-paged pool usage, in bytes.
     */
    static getPeakNonPagedPoolUsage(): void;
    /**
     * Return the peak paged pool usage, in bytes.
     */
    static getPeakPagedPoolUsage(): void;
    /**
     * Return the peak space allocated for the pagefile, in bytes.
     */
    static getPeakPagefileUsage(): void;
    /**
     * Return the peak working set size, in bytes.
     */
    static getPeakWorkingSetSize(): void;
    /**
     * Same as getCpuUsage, but will return consistent values on all platforms
     * (canceling the Windows exception mentioned above) by returning a value in the
     * rage of `0` to `100 * numCores` everywhere.
     */
    static getPlatformIndependentCPUUsage(): void;
    /**
     * Return the full path to the executable used to create the process.
     */
    static getProcessFilename(): void;
    /**
     * Return the working set size, in bytes.
     */
    static getWorkingSetSize(): void;
    /**
     * An `Integer` representing process id (`pid`).
     */
  ...
  class ProcessMonitor extends NodeJS.EventEmitter {
    ...
    on(event: 'process-terminated', listener: (
                                               /**
                                                * process handle for terminated process
                                                */
                                               handle: number,
                                               /**
                                                * process id for terminated process
                                                */
                                               pid: number,
                                               /**
                                                * exit code for terminated process if exit code is available.
                                                */
                                               exit_code: number) => void): this;
    once(event: 'process-terminated', listener: (
                                               /**
                                                * process handle for terminated process
                                                */
                                               handle: number,
                                                ...
                                                */
                                               exit_code: number) => void): this;
    addListener(event: 'process-terminated', listener: (
                                               /**
                                                * process handle for terminated process
                                                */
                                               handle: number,
                                                ...
                                                */
                                               exit_code: number) => void): this;
    removeListener(event: 'process-terminated', listener: (
                                               /**
                                                * process handle for terminated process
                                                */
                                               handle: number,
                                               ...
                                               exit_code: number) => void): this;
    /**
     * Adds the process specified by `object` to the list of monitored processes. An
     * event will be emitted when the process terminates.
     */
    static add(object: unknown): void;
    /**
     * Removes the process specified by <object> from the list of monitored processes.
     */
    static remove(object: unknown): void;
    /**
     * Stops the process monitor and removes all processes from the list of monitored
     * processes. The process monitor will start again when a process is added with the
     * add() method.
     */
    static stop(): void;
  }
...
e.g.
  ...
  interface Screen extends NodeJS.EventEmitter {
     ...
     * resolution changing. The `changedMetrics` is an array of strings that describe
     * the changes. Possible values are `bounds` and `workArea`.
     */
...
This property is only available on macOS 10.14 Mojave or newer.
  ...
  interface Task {
    ...
    // Docs: http://electronjs.org/docs\api\structures\task
  ...
  interface ThumbarButton {
    ...
    // Docs: http://electronjs.org/docs\api\structures\thumbar-button
  ...
  class TouchBarColorPicker extends NodeJS.EventEmitter {
    ...
    // Docs: http://electronjs.org/docs\api\touch-bar-color-picker
  ...
  class TouchBarGroup extends NodeJS.EventEmitter {
    ...
    // Docs: http://electronjs.org/docs\api\touch-bar-group
  ...
  class TouchBarLabel extends NodeJS.EventEmitter {
    ...
    // Docs: http://electronjs.org/docs\api\touch-bar-label
  ...
  class TouchBarPopover extends NodeJS.EventEmitter {
    ...
    // Docs: http://electronjs.org/docs\api\touch-bar-popover
  ...
  class TouchBarScrubber extends NodeJS.EventEmitter {
    ...
    // Docs: http://electronjs.org/docs\api\touch-bar-scrubber
  ...
  class TouchBarSegmentedControl extends NodeJS.EventEmitter {
    ...
    // Docs: http://electronjs.org/docs\api\touch-bar-segmented-control
  ...
  class TouchBarSlider extends NodeJS.EventEmitter {
    ...
    // Docs: http://electronjs.org/docs\api\touch-bar-slider
  ...
  class TouchBarSpacer extends NodeJS.EventEmitter {
    ...
    // Docs: http://electronjs.org/docs\api\touch-bar-spacer
  ...
  interface TraceCategoriesAndOptions {
    ...
    // Docs: http://electronjs.org/docs\api\structures\trace-categories-and-options
  ...
  interface TraceConfig {
    ...
    // Docs: http://electronjs.org/docs\api\structures\trace-config
  ...
  interface Transaction {
    ...
    // Docs: http://electronjs.org/docs\api\structures\transaction
  ...
  class Tray extends NodeJS.EventEmitter {
    ...
    // Docs: http://electronjs.org/docs\api\tray
    ...
    addListener(event: 'hover', listener: Function): this;
...
This value is set to false by default.
  ...
  class WebContents extends NodeJS.EventEmitter {
    ...
    /**
     * A WebContents instance with the given ID and Frame id.
     */
...
The usage is the same with the `certificate-error` event of `app`.
     ...
     *
     * **Deprecated**: This event has been deprecated. Use the `webRequest` module
     * which provides similar navigation details on a subscription basis.
     */
...
**Deprecated**
    ...
    /**
     * Returns an object containing `frameRoutingId` and the `frameName` if a frame
     * within the referenced web contents is found. The name is a GUID that is stored
     * locally in a map and is used in the Hadouken Core as api endpoints (inter-app
     * etc).
     */
...
**Deprecated**
    ...
    isPainting(): boolean;
    /**
     * Called in the Hadouken Core. Whether the frame id passed in has authority to
     * make api calls.
     */
...
An example of showing devtools in a `BrowserWindow`:
    ...
    /**
     * Called in the Hadouken Core with the frame connect strategy via the
     * `frameConnect` option. Defaults to `'last'`.
     */
    setFrameConnectStrategy(strategy: string): undefined;
    /**
...
See webContents.sendInputEvent for detailed description of `event` object.
  ...
  class WindowTransaction extends NodeJS.EventEmitter {
    ...
    commit(): void;
    /**
     * Sets the window position, size, and z order for a window.
     *
     * hwnd is the integer Windows HWND handle of the window you want to update.
     *
     * hwndafter  Can be a window handle or one of the following: hwndBottom - send to
     * bottom of z order hwndTop - bring to top of z order hwndTopMost - enable topmost
     * property hwndNoTopMost - disable topmost property
     *
     * flags - Can be one of the following: noMove - x, y not required noSize - w,h not
     * required noZorder - hwndafter not required noActivate - don't activate window
     * show - show the window hide - hide the window
     */
    setWindowPos(hwnd: number, options: WindowPosOptions): void;
  }

  class WinEventHookEmitter extends NodeJS.EventEmitter {
    ...
    once(event: 'EVENT_AIA_START' | 'EVENT_AIA_END' | 'EVENT_OBJECT_ACCELERATORCHANGE' | 'EVENT_OBJECT_CLOAKED' | 'EVENT_OBJECT_CONTENTSCROLLED' | 'EVENT_OBJECT_CREATE' | 'EVENT_OBJECT_DEFACTIONCHANGE' | 'EVENT_OBJECT_DESCRIPTIONCHANGE' | 'EVENT_OBJECT_DESTROY' | 'EVENT_OBJECT_DRAGSTART' | 'EVENT_OBJECT_DRAGCANCEL' | 'EVENT_OBJECT_DRAGCOMPLETE' | 'EVENT_OBJECT_DRAGENTER' | 'EVENT_OBJECT_DRAGLEAVE' | 'EVENT_OBJECT_DRAGDROPPED' | 'EVENT_OBJECT_END' | 'EVENT_OBJECT_FOCUS' | 'EVENT_OBJECT_HELPCHANGE' | 'EVENT_OBJECT_HIDE' | 'EVENT_OBJECT_HOSTEDOBJECTSINVALIDATED' | 'EVENT_OBJECT_IME_HIDE' | 'EVENT_OBJECT_IME_SHOW' | 'EVENT_OBJECT_IME_CHANGE' | 'EVENT_OBJECT_INVOKED' | 'EVENT_OBJECT_LIVEREGIONCHANGED' | 'EVENT_OBJECT_LOCATIONCHANGE' | 'EVENT_OBJECT_NAMECHANGE' | 'EVENT_OBJECT_PARENTCHANGE' | 'EVENT_OBJECT_REORDER' | 'EVENT_OBJECT_SELECTION' | 'EVENT_OBJECT_SELECTIONADD' | 'EVENT_OBJECT_SELECTIONREMOVE' | 'EVENT_OBJECT_SELECTIONWITHIN' | 'EVENT_OBJECT_SHOW' | 'EVENT_OBJECT_STATECHANGE' | 'EVENT_OBJECT_TEXTEDIT_CONVERSIONTARGETCHANGED' | 'EVENT_OBJECT_TEXTSELECTIONCHANGED' | 'EVENT_OBJECT_UNCLOAKED' | 'EVENT_OBJECT_VALUECHANGE' | 'EVENT_OEM_DEFINED_START' | 'EVENT_OEM_DEFINED_END' | 'EVENT_SYSTEM_ALERT' | 'EVENT_SYSTEM_ARRANGMENTPREVIEW' | 'EVENT_SYSTEM_CAPTUREEND' | 'EVENT_SYSTEM_CAPTURESTART' | 'EVENT_SYSTEM_CONTEXTHELPEND' | 'EVENT_SYSTEM_CONTEXTHELPSTART' | 'EVENT_SYSTEM_DESKTOPSWITCH' | 'EVENT_SYSTEM_DIALOGEND' | 'EVENT_SYSTEM_DIALOGSTART' | 'EVENT_SYSTEM_DRAGDROPEND' | 'EVENT_SYSTEM_DRAGDROPSTART' | 'EVENT_SYSTEM_END' | 'EVENT_SYSTEM_FOREGROUND' | 'EVENT_SYSTEM_MENUPOPUPEND' | 'EVENT_SYSTEM_MENUPOPUPSTART' | 'EVENT_SYSTEM_MENUEND' | 'EVENT_SYSTEM_MENUSTART' | 'EVENT_SYSTEM_MINIMIZEEND' | 'EVENT_SYSTEM_MINIMIZESTART' | 'EVENT_SYSTEM_MOVESIZEEND' | 'EVENT_SYSTEM_MOVESIZESTART' | 'EVENT_SYSTEM_SCROLLINGEND' | 'EVENT_SYSTEM_SCROLLINGSTART' | 'EVENT_SYSTEM_SOUND' | 'EVENT_SYSTEM_SWITCHEND' | 'EVENT_SYSTEM_SWITCHSTART' | 'EVENT_UIA_EVENTID_START' | 'EVENT_UIA_EVENTID_END' | 'EVENT_UIA_PROPID_START' | 'EVENT_UIA_PROPID_END', listener: (event: Event,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * A `NativeWindowInfo` object for the window or control that the event was
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * generated for.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               */
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               */
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              eventThreadId: number) => void): this;
    addListener(event: 'EVENT_AIA_START' | 'EVENT_AIA_END' | 'EVENT_OBJECT_ACCELERATORCHANGE' | 'EVENT_OBJECT_CLOAKED' | 'EVENT_OBJECT_CONTENTSCROLLED' | 'EVENT_OBJECT_CREATE' | 'EVENT_OBJECT_DEFACTIONCHANGE' | 'EVENT_OBJECT_DESCRIPTIONCHANGE' | 'EVENT_OBJECT_DESTROY' | 'EVENT_OBJECT_DRAGSTART' | 'EVENT_OBJECT_DRAGCANCEL' | 'EVENT_OBJECT_DRAGCOMPLETE' | 'EVENT_OBJECT_DRAGENTER' | 'EVENT_OBJECT_DRAGLEAVE' | 'EVENT_OBJECT_DRAGDROPPED' | 'EVENT_OBJECT_END' | 'EVENT_OBJECT_FOCUS' | 'EVENT_OBJECT_HELPCHANGE' | 'EVENT_OBJECT_HIDE' | 'EVENT_OBJECT_HOSTEDOBJECTSINVALIDATED' | 'EVENT_OBJECT_IME_HIDE' | 'EVENT_OBJECT_IME_SHOW' | 'EVENT_OBJECT_IME_CHANGE' | 'EVENT_OBJECT_INVOKED' | 'EVENT_OBJECT_LIVEREGIONCHANGED' | 'EVENT_OBJECT_LOCATIONCHANGE' | 'EVENT_OBJECT_NAMECHANGE' | 'EVENT_OBJECT_PARENTCHANGE' | 'EVENT_OBJECT_REORDER' | 'EVENT_OBJECT_SELECTION' | 'EVENT_OBJECT_SELECTIONADD' | 'EVENT_OBJECT_SELECTIONREMOVE' | 'EVENT_OBJECT_SELECTIONWITHIN' | 'EVENT_OBJECT_SHOW' | 'EVENT_OBJECT_STATECHANGE' | 'EVENT_OBJECT_TEXTEDIT_CONVERSIONTARGETCHANGED' | 'EVENT_OBJECT_TEXTSELECTIONCHANGED' | 'EVENT_OBJECT_UNCLOAKED' | 'EVENT_OBJECT_VALUECHANGE' | 'EVENT_OEM_DEFINED_START' | 'EVENT_OEM_DEFINED_END' | 'EVENT_SYSTEM_ALERT' | 'EVENT_SYSTEM_ARRANGMENTPREVIEW' | 'EVENT_SYSTEM_CAPTUREEND' | 'EVENT_SYSTEM_CAPTURESTART' | 'EVENT_SYSTEM_CONTEXTHELPEND' | 'EVENT_SYSTEM_CONTEXTHELPSTART' | 'EVENT_SYSTEM_DESKTOPSWITCH' | 'EVENT_SYSTEM_DIALOGEND' | 'EVENT_SYSTEM_DIALOGSTART' | 'EVENT_SYSTEM_DRAGDROPEND' | 'EVENT_SYSTEM_DRAGDROPSTART' | 'EVENT_SYSTEM_END' | 'EVENT_SYSTEM_FOREGROUND' | 'EVENT_SYSTEM_MENUPOPUPEND' | 'EVENT_SYSTEM_MENUPOPUPSTART' | 'EVENT_SYSTEM_MENUEND' | 'EVENT_SYSTEM_MENUSTART' | 'EVENT_SYSTEM_MINIMIZEEND' | 'EVENT_SYSTEM_MINIMIZESTART' | 'EVENT_SYSTEM_MOVESIZEEND' | 'EVENT_SYSTEM_MOVESIZESTART' | 'EVENT_SYSTEM_SCROLLINGEND' | 'EVENT_SYSTEM_SCROLLINGSTART' | 'EVENT_SYSTEM_SOUND' | 'EVENT_SYSTEM_SWITCHEND' | 'EVENT_SYSTEM_SWITCHSTART' | 'EVENT_UIA_EVENTID_START' | 'EVENT_UIA_EVENTID_END' | 'EVENT_UIA_PROPID_START' | 'EVENT_UIA_PROPID_END', listener: (event: Event,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * A `NativeWindowInfo` object for the window or control that the event was
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * generated for.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               */
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               */
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              eventThreadId: number) => void): this;
    removeListener(event: 'EVENT_AIA_START' | 'EVENT_AIA_END' | 'EVENT_OBJECT_ACCELERATORCHANGE' | 'EVENT_OBJECT_CLOAKED' | 'EVENT_OBJECT_CONTENTSCROLLED' | 'EVENT_OBJECT_CREATE' | 'EVENT_OBJECT_DEFACTIONCHANGE' | 'EVENT_OBJECT_DESCRIPTIONCHANGE' | 'EVENT_OBJECT_DESTROY' | 'EVENT_OBJECT_DRAGSTART' | 'EVENT_OBJECT_DRAGCANCEL' | 'EVENT_OBJECT_DRAGCOMPLETE' | 'EVENT_OBJECT_DRAGENTER' | 'EVENT_OBJECT_DRAGLEAVE' | 'EVENT_OBJECT_DRAGDROPPED' | 'EVENT_OBJECT_END' | 'EVENT_OBJECT_FOCUS' | 'EVENT_OBJECT_HELPCHANGE' | 'EVENT_OBJECT_HIDE' | 'EVENT_OBJECT_HOSTEDOBJECTSINVALIDATED' | 'EVENT_OBJECT_IME_HIDE' | 'EVENT_OBJECT_IME_SHOW' | 'EVENT_OBJECT_IME_CHANGE' | 'EVENT_OBJECT_INVOKED' | 'EVENT_OBJECT_LIVEREGIONCHANGED' | 'EVENT_OBJECT_LOCATIONCHANGE' | 'EVENT_OBJECT_NAMECHANGE' | 'EVENT_OBJECT_PARENTCHANGE' | 'EVENT_OBJECT_REORDER' | 'EVENT_OBJECT_SELECTION' | 'EVENT_OBJECT_SELECTIONADD' | 'EVENT_OBJECT_SELECTIONREMOVE' | 'EVENT_OBJECT_SELECTIONWITHIN' | 'EVENT_OBJECT_SHOW' | 'EVENT_OBJECT_STATECHANGE' | 'EVENT_OBJECT_TEXTEDIT_CONVERSIONTARGETCHANGED' | 'EVENT_OBJECT_TEXTSELECTIONCHANGED' | 'EVENT_OBJECT_UNCLOAKED' | 'EVENT_OBJECT_VALUECHANGE' | 'EVENT_OEM_DEFINED_START' | 'EVENT_OEM_DEFINED_END' | 'EVENT_SYSTEM_ALERT' | 'EVENT_SYSTEM_ARRANGMENTPREVIEW' | 'EVENT_SYSTEM_CAPTUREEND' | 'EVENT_SYSTEM_CAPTURESTART' | 'EVENT_SYSTEM_CONTEXTHELPEND' | 'EVENT_SYSTEM_CONTEXTHELPSTART' | 'EVENT_SYSTEM_DESKTOPSWITCH' | 'EVENT_SYSTEM_DIALOGEND' | 'EVENT_SYSTEM_DIALOGSTART' | 'EVENT_SYSTEM_DRAGDROPEND' | 'EVENT_SYSTEM_DRAGDROPSTART' | 'EVENT_SYSTEM_END' | 'EVENT_SYSTEM_FOREGROUND' | 'EVENT_SYSTEM_MENUPOPUPEND' | 'EVENT_SYSTEM_MENUPOPUPSTART' | 'EVENT_SYSTEM_MENUEND' | 'EVENT_SYSTEM_MENUSTART' | 'EVENT_SYSTEM_MINIMIZEEND' | 'EVENT_SYSTEM_MINIMIZESTART' | 'EVENT_SYSTEM_MOVESIZEEND' | 'EVENT_SYSTEM_MOVESIZESTART' | 'EVENT_SYSTEM_SCROLLINGEND' | 'EVENT_SYSTEM_SCROLLINGSTART' | 'EVENT_SYSTEM_SOUND' | 'EVENT_SYSTEM_SWITCHEND' | 'EVENT_SYSTEM_SWITCHSTART' | 'EVENT_UIA_EVENTID_START' | 'EVENT_UIA_EVENTID_END' | 'EVENT_UIA_PROPID_START' | 'EVENT_UIA_PROPID_END', listener: (event: Event,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * A `NativeWindowInfo` object for the window or control that the event was
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * generated for.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               */
